...
Run: python -m veriforge_mcp.tools_v2 --test
"""
...
# Import tool schema definitions from v1 (schema stays the same)
from .tools import VERICLAW_TOOLS
...
"""
    ...
    print(f"  {'✅' if passed else '❌'} {results[-1][2]}")
